...
Params.Tmont = 50;   % Number of Monte-Carlo repeats
...
for mm = mrange
    ...
    for t = 1 : Params.Tmont
        ...
        Err_SE_prac(find(mm == nrange), t)  = ERULRPRQR(t);
        ...
        Err_SE_theory(find(mm == nrange), t)  = ERULRPRmes(t);
        ...
        Err_SE_AltMin(find(mm == nrange), t)  = TmpErULRPROld(t);
        ...
        Err_SE_RWF(find(mm == nrange), t)  = TmpErUrwf(t);
